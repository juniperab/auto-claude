  ...
  module Output
    class FormatterTest < Minitest::Test
      ...
      def test_format_ls_tool
        ...
        assert_match(/📂 Listing \/Users\/project\//, output)
      end
      ...
      def test_format_ls_tool_with_ignore
        ...
        assert_match(/📂 Listing \/src\//, output)
      ...
      def test_format_mcp_github_tool
        ...
        assert_match(/📥 Get Issue: acme-corp\/main-app#123/, output)
      ...
      def test_format_glob
        ...
        assert_match(/🎯 Searching for \*\*\/\*\.rb/, output)
      end
      ...
      def test_format_session_start
        ...
        assert_match(/🚀 Session: starting in \/Users\/project/, output)
      end
