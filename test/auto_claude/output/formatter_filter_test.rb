  ...
  module Output
    class FormatterFilterTest < Minitest::Test
      ...
      def test_can_add_new_filter_prefix
        ...
        assert_kind_of Array, AutoClaude::Output::FormatterConfig::FILTERED_MESSAGE_PREFIXES
        assert_predicate AutoClaude::Output::FormatterConfig::FILTERED_MESSAGE_PREFIXES, :frozen?
        assert_includes AutoClaude::Output::FormatterConfig::FILTERED_MESSAGE_PREFIXES, "Todos have been modified successfully"
      end
