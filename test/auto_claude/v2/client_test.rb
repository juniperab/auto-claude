...
class AutoClaude::V2::ClientTest < Minitest::Test
  def setup
  ...
  def test_initialize_with_defaults
    ...
    assert_kind_of AutoClaude::V2::Output::Terminal, client.instance_variable_get(:@output)
    assert_empty client.sessions
  end

  def test_initialize_with_custom_directory
    Dir.mktmpdir do |tmpdir|
      client = AutoClaude::V2::Client.new(directory: tmpdir)
  ...
  def test_initialize_with_invalid_directory
    assert_raises(ArgumentError) do
      AutoClaude::V2::Client.new(directory: "/nonexistent/path")
    end
  end

  def test_initialize_with_custom_output
    client = AutoClaude::V2::Client.new(output: @memory_output)
  ...
  def test_run_creates_session
    ...
    AutoClaude::V2::Process::Manager.stub :new, MockProcessManager.new do
      session = client.run("test prompt")
      
      assert_kind_of AutoClaude::V2::Session, session
