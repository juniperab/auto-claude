  ...
  module Output
    module Formatters
      class Todo < Base
        ...
        def select_display_items(_todos, stats)
          items = []
          ...
          items.concat(stats[:completed].last(completed_to_show)) if completed_to_show.positive?

          items.concat(stats[:in_progress].first(in_progress_to_show)) if in_progress_to_show.positive?

          items.concat(stats[:pending].first(pending_to_show)) if pending_to_show.positive?
